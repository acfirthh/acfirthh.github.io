...
![HackTheBox: Ghost (Insane)](/assets/images/writeups/htb/ghost/ghost.png)
...
![FFUF Subdomain Scan](/assets/images/writeups/htb/ghost/ffuf_subdomain_scan.png)
...
![Ghost CMS Blog](/assets/images/writeups/htb/ghost/ghost_website.png)
...
![Intranet Login](/assets/images/writeups/htb/ghost/intranet_login_page.png)

Viewing the **intranet** subdomain, I was immediately met with a basic login page prompting for a username and a secret.

![Intranet Login Page Source](/assets/images/writeups/htb/ghost/intranet_login_page_source.png)
...
![LDAP Injection Login](/assets/images/writeups/htb/ghost/intranet_ldap_injection.png)
...
![Intranet Users List](/assets/images/writeups/htb/ghost/intranet_users.png)
...
![justin.bradley Forum Post](/assets/images/writeups/htb/ghost/intranet_forum_DNS_post.png)
...
![Secret Token Brute-force](/assets/images/writeups/htb/ghost/ldap_secret_bruteforce.png)
...
![Gitea Blog Repo README](/assets/images/writeups/htb/ghost/gitea_ghost_blog_readme.png)
...
![LFI Vulnerability](/assets/images/writeups/htb/ghost/gitea_blog_lfi_code.png)
...
![Dev API RCE](/assets/images/writeups/htb/ghost/gitea_dev_api_rce_code.png)
...
![Reverse Shell](/assets/images/writeups/htb/ghost/getting_a_shell.png)
...
![SSH Connection as florence.ramirez](/assets/images/writeups/htb/ghost/ssh_florence_ramirez.png)
...
![klist Kerberos Tickets](/assets/images/writeups/htb/ghost/klist_kerberos_tickets.png)
...
![Responder justin.bradley Hash](/assets/images/writeups/htb/ghost/captured_justin_bradley_hash.png)

I then copied the captured hash into a file and used **JohnTheRipper** to crack the hash.

![Cracked justin.bradley Hash](/assets/images/writeups/htb/ghost/cracked_justin_bradley_hash.png)
...
![Ghost Core Website](/assets/images/writeups/htb/ghost/ghost_core_login.png)
...
![Ghost Federation Login](/assets/images/writeups/htb/ghost/ghost_federation_login_page.png)
...
![Ghost Federation Admin Only](/assets/images/writeups/htb/ghost/ghost_federation_admin_only.png)
...
![Running ADFSDump](/assets/images/writeups/htb/ghost/run_ADFSDump.png)
...
![Generating Forged GoldenSAML](/assets/images/writeups/htb/ghost/forged_administrator_saml.png)
...
![Intercepted SAML Request](/assets/images/writeups/htb/ghost/captured_saml_request.png)
...
![MSSQL Config Panel](/assets/images/writeups/htb/ghost/bypassed_federation_login_config_panel.png)
...
![Simple SQL Query](/assets/images/writeups/htb/ghost/simple_sql_query.png)
...
![PowerJoker Payload](/assets/images/writeups/htb/ghost/powerjoker_payload.png)
...
![PowerJoker Session](/assets/images/writeups/htb/ghost/shell_as_mssqlserver.png)
...
So, I downloaded the **EfsPotato.cs** file to my machine, hosted a simple Python HTTP server, and used **curl** to download it onto the target in the directory `C:\Users\Public\Downloads`.
...
![Compiling EfsPotato](/assets/images/writeups/htb/ghost/efspotato_compile.png)
...
![Shell as NT AUTHORITY\SYSTEM](/assets/images/writeups/htb/ghost/shell_as_system.png)
...
![Disable Real-Time Protection](/assets/images/writeups/htb/ghost/disable_defender.png)
...
![Meterpreter Shell](/assets/images/writeups/htb/ghost/meterpreter_shell.png)
...
![Get Trust Key](/assets/images/writeups/htb/ghost/mimikatz_get_trust_key.png)
...
![Generate Forged Trust Ticket](/assets/images/writeups/htb/ghost/generate_forged_trust_ticket.png)
...
![Using the Forged Ticket with Rubeus](/assets/images/writeups/htb/ghost/rubeus_use_forged_ticket.png)
...
![Accessing the Filesystem of the DC](/assets/images/writeups/htb/ghost/access_dc01_filesystem.png)

And finally, get the root flag stored in the **Administrator's** desktop...

![Get root flag](/assets/images/writeups/htb/ghost/get_root_flag.png)
