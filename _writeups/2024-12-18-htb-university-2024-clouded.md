...
## Reconaissance
### NMAP Scan
![NMAP Scan](/assets/images/writeups/htb-university-ctf-2024/clouded/nmap_scan.png)
...
### FFUF Subdomain Scan
![FFUF Subdomain Scan](/assets/images/writeups/htb-university-ctf-2024/clouded/local_subdomain.png)
...
![Upload Page](/assets/images/writeups/htb-university-ctf-2024/clouded/clouded_upload_page.png)
...
![/proc/self/environ](/assets/images/writeups/htb-university-ctf-2024/clouded/aws_keys_in_proc_self_environ.png)
...
![local.clouded.htb error](/assets/images/writeups/htb-university-ctf-2024/clouded/local_access_denied_error.png)
...
![Exposed Directories via path traversal](/assets/images/writeups/htb-university-ctf-2024/clouded/disclosed_endpoints_local.png)
...
![Exposed backup.db](/assets/images/writeups/htb-university-ctf-2024/clouded/disclosed_backup_db.png)
...
![Cracked Hashes](/assets/images/writeups/htb-university-ctf-2024/clouded/cracked_hashes.png)
...
![Hydra SSH Brute-force](/assets/images/writeups/htb-university-ctf-2024/clouded/ssh_brute_force.png)

**SSH Credentials: nagato / alicia**

I was then able to login to SSH using the correct credentials.

![SSH Login](/assets/images/writeups/htb-university-ctf-2024/clouded/ssh_nagto_login.png)
...
![Ansible-playbook process](/assets/images/writeups/htb-university-ctf-2024/clouded/monitoring_hidden_jobs.png)
...
![SUID bash](/assets/images/writeups/htb-university-ctf-2024/clouded/suid_bash.png)

**SUCCESS!** Now I was able to spawn a root shell using the command `bash -p`

![Root Shell](/assets/images/writeups/htb-university-ctf-2024/clouded/priv_esc.png)
