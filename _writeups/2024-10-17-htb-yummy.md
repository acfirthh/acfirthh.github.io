...
![HackTheBox: Yummy (Hard)](/assets/images/writeups/htb/yummy/yummy.png)
...
## Reconaissance
### NMAP Scan
![NMAP Scan](/assets/images/writeups/htb/yummy/recon.png)

**(Add "yummy.htb" to /etc/hosts)**

### Gobuster Scan
![Gobuster Scan](/assets/images/writeups/htb/yummy/gobuster.png)
...
![yummy.htb Front Page](/assets/images/writeups/htb/yummy/front_page.png)
...
![Registering an Account](/assets/images/writeups/htb/yummy/register.png)
...
![User Dashboard](/assets/images/writeups/htb/yummy/dashboard.png)
This looked like it'll be where all of a user's table bookings will be located.

### Booking a Table
![Booking a Table](/assets/images/writeups/htb/yummy/book_a_table.png)
...
![Reservation Booking](/assets/images/writeups/htb/yummy/dashboard_booked.png)
...
![Save iCalendar /export Request](/assets/images/writeups/htb/yummy/save_iCalender_request_p2.png)
...
![LFI Payload](/assets/images/writeups/htb/yummy/save_iCalender_LFI_request.png)
...
![Admin Dashboard](/assets/images/writeups/htb/yummy/admindashboard.png)
...
![Reverse Shell Request](/assets/images/writeups/htb/yummy/mysql_revshell_http_req.png)

Then execute the reverse shell to get a callback on my listener:

![mysql User Reverse Shell](/assets/images/writeups/htb/yummy/mysql_revshell.png)
...
![Download Reverse Shell](/assets/images/writeups/htb/yummy/mysql_www-data_privesc_1.png)
...
![www-data Reverse Shell](/assets/images/writeups/htb/yummy/www-data_revshell.png)
...
![Reverse Shell Call](/assets/images/writeups/htb/yummy/qa_to_dev_privesc_nano.png)
...
![Activate Reverse Shell](/assets/images/writeups/htb/yummy/activate_qa_dev_shell.png)

![Shell as dev](/assets/images/writeups/htb/yummy/dev_revshell.png)
...
![Dev to root Priv-Esc](/assets/images/writeups/htb/yummy/dev_to_root_privesc.png)
