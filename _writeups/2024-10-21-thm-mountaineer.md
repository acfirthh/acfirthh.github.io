...
![Nginx Default Webpage](/assets/images/writeups/thm/mountaineer/nginx.png)

### Gobuster Scan:
![Gobuster Scan](/assets/images/writeups/thm/mountaineer/initial_gobuster_scan.png)
...
![Mountaineer WordPress Site](/assets/images/writeups/thm/mountaineer/wordpress.png)

### WordPress Gobuster Scan:
![WordPress Gobuster Scan](/assets/images/writeups/thm/mountaineer/wordpress_gobuster_scan.png)
...
![Modern Events Calendar Vulnerabilities](/assets/images/writeups/thm/mountaineer/modern_events_calendar_exploits_searchsploit.png)
...
![Exported Events](/assets/images/writeups/thm/mountaineer/extracted_events.png)
...
![Alias Misconfiguration](/assets/images/writeups/thm/mountaineer/hacktricks_nginx_lfi.png)
...
![/etc/passwd](/assets/images/writeups/thm/mountaineer/lfi_passwd.png)
...
![/etc/nginx/sites-enabled/default](/assets/images/writeups/thm/mountaineer/lfi_sites_available_roundcube_domain.png)
...
![RoundCube Webmail Login Page](/assets/images/writeups/thm/mountaineer/roundcube_mail.png)
...
![K2 Mentioned by admin](/assets/images/writeups/thm/mountaineer/admin_k2_posts.png)
...
![Lhotse - Security Risk Email](/assets/images/writeups/thm/mountaineer/k2_security_risk_email.png)

Knowing this new information, I checked the second email from the user **nanga**, and to no surprise there was a password.

![K2's Password](/assets/images/writeups/thm/mountaineer/k2_roundcube_passw_email.png)
...
![Meterpreter Shell as www-data](/assets/images/writeups/thm/mountaineer/metasploit_www-data_modern_events_rce.png)
...
![Downloading Backup.kdbx](/assets/images/writeups/thm/mountaineer/download_backup_kdbx.png)
...
![Lhotse Personal Information](/assets/images/writeups/thm/mountaineer/k2_sent_lhotse_email.png)
...
![JohnTheRipper KeePass Hash](/assets/images/writeups/thm/mountaineer/keepass_hash_crack.png)
...
![KeePass Stored Passwords](/assets/images/writeups/thm/mountaineer/keepass_kangchenjunga_passw.png)
...
![mynotes.txt & .bash_history](/assets/images/writeups/thm/mountaineer/priv-esc_to_root.png)
